...
<div class="row">
    ...
    <div class="col-md-3">
        <div class="small-box bg-white">
            <div class="inner">
                <div class="green-background" style="padding: 5px; border-radius: 5px;">
                    <h4 style="color: white; font-family: 'Arial', sans-serif; text-align: center; margin: 0; text-shadow: 1px 1px 2px rgba(0, 0, 0, 0.5);">Organisations Admins</h4>
                </div>
                <h3 style="margin-top: 10px; text-align: center;">{{ $totalOrgAdmins }}</h3>
            </div>
        </div>
    </div>
    <div class="col-md-3">
        <div class="small-box bg-white">
            <div class="inner">
                <div class="green-background" style="padding: 5px; border-radius: 5px;">
                    <h4 style="color: white; font-family: 'Arial', sans-serif; text-align: center; margin: 0; text-shadow: 1px 1px 2px rgba(0, 0, 0, 0.5);">Group Accounts</h4>
                </div>
                <h3 style="margin-top: 10px; text-align: center;">{{ $totalAccounts }}</h3>
            </div>
        </div>
    </div>
    <div class="col-md-3">
