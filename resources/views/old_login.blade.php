                ...
                <form  action="{{ admin_url('auth/login') }}" method="post">
                    <div class="mb-3">
                        @if ($errors->has('username'))
                            ...
                            @endforeach
                        @endif
                        <input type="text" class="form-control" placeholder="Type your email or username"
            ...
            $('#resetPasswordForm').on('submit', function(e) {
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        ...
                        toastr.success(response.message || 'Password reset instructions sent!');
                    },
                    error: function(xhr) {
                        hideLoader();
                        toastr.error(xhr.responseJSON.message ||
