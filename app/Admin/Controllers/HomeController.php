...
class HomeController extends Controller
{
    ...
    public function exportData(Request $request)
    {
        ...
        $statistics = [
            ...
            'pwdMaleSavings' => $this->getTotalBalance($pwdUsers->where('sex', 'Male'), 'SHARE', $startDate, $endDate),
            'pwdFemaleSavings' => $this->getTotalBalance($pwdUsers->where('sex', 'Female'), 'SHARE', $startDate, $endDate),
