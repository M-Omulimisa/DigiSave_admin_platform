    ...
    return $user->user_type === null || !in_array($user->user_type, ['Admin', '5']);
        ...
        if (!$admin->isRole('admin')){
            ...
            //   $logoUrl = 'http://127.0.0.1:8000/storage/' . $organization->logo;
              $organizationContainer = '<div style="text-align: center; padding-bottom: 25px;"><img src="' . $logoUrl . '" alt="' . $organization->name . ' Logo class="img-fluid rounded-circle" style="max-width: 150px;"></div>';
