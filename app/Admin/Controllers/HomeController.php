...
class HomeController extends Controller
{
    ...
    public function exportData(Request $request)
    {
        ...
        if (!$this->checkIfUserHasRole($admin, 'admin')) {
    ...
    public function index(Content $content)
    {
        ...
        return $content
            ...
            border-radius: 16px;
            margin: 15px 0;
            box-shadow: 0 10px 20px rgba(19, 78, 94, 0.15);
            letter-spacing: 0.5px;">
            <div style="font-size: 28px; font-weight: 600; margin-bottom: 4px;">
                ' . $orgName . '
            </div>
            ' . (!$this->checkIfUserHasRole($admin, 'admin') && !empty($adminRegion) ? '
            <div style="
                font-size: 16px;
            ...
            ->body(
                ...
                $organizationSelector .
                    $organizationContainer .
                    '<div style="
                    background: linear-gradient(135deg, #fff, #f9fbfa);
                    padding: 25px;
                    border-radius: 16px;
                    margin-bottom: 25px;
                ...
                <form action="' . route(config('admin.route.prefix') . '.export-data') . '"
                    ...
                    <button type="submit"
                            ...
                            style="
                                ...
                                font-weight: 600;
                                font-size: 14px;
                                box-shadow: 0 6px 12px rgba(19, 78, 94, 0.15);
                                transition: all 0.2s ease;
                                cursor: pointer;"
                            onmouseover="this.style.transform=\'translateY(-2px)\'; this.style.boxShadow=\'0 8px 15px rgba(19, 78, 94, 0.2)\';"
                            onmouseout="this.style.transform=\'translateY(0)\'; this.style.boxShadow=\'0 6px 12px rgba(19, 78, 94, 0.15)\';">
                        Export Data
                    </button>
                </form>
            </div>' .
                ...
                <div class="row" style="display: flex; flex-wrap: wrap; margin: 0 -10px;">
                    ...
                    <div class="col-md-6 col-lg-4" style="padding: 10px;">
                        <div class="card">
                            <div class="card-body">
                                <h5 class="card-title">Number of Members by Gender</h5>
                                <p class="card-text">
                                    <strong>Female:</strong> ' . $femaleMembersCount . '<br>
                                    <strong>Male:</strong> ' . $maleMembersCount . '<br>
                                    <strong>Refugees:</strong> ' . $refugeMaleUsersCount + $refugeFemaleUsersCount . '<br>
                                    <strong>Youth:</strong> ' . $youthMembersCount . '<br>
                                    <strong>PWDs:</strong> ' . $pwdMembersCount . '
                                </p>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-6 col-lg-4" style="padding: 10px;">
                        <div class="card">
                            <div class="card-body">
                                <h5 class="card-title">Savings by Gender</h5>
                                <p class="card-text">
                                    <strong>Female:</strong> ' . $this->formatCurrency($femaleTotalBalance) . '<br>
                    ...
                    <div class="col-md-6 col-lg-4" style="padding: 10px;">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <p class="card-text">' . $this->formatCurrency($totalLoanAmount) . '</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-6 col-lg-4" style="padding: 10px;">
                        <div class="card">
                            <div class="card-body">
                                <h5 class="card-title">Loans by Gender</h5>
                                <p class="card-text">
                                    <strong>Female:</strong> ' . $this->formatCurrency($loanSumForWomen) . '<br>
                                    <strong>Male:</strong> ' . $this->formatCurrency($loanSumForMen) . '<br>
                                    <strong>Loans by Youth:</strong> ' . $this->formatCurrency($loanSumForYouths) . '<br>
                                    <strong>Loans by Refugees:</strong> ' . $this->formatCurrency($refugeeMaleLoanCount + $refugeeFemaleLoanCount) . '<br>
                                    <strong>Loans by PWDs:</strong> ' . $this->formatCurrency($pwdMaleLoanCount + $pwdFemaleLoanCount) . '
                                </p>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-6 col-lg-4" style="padding: 10px;">
                        <div class="card">
                            <div class="card-body">
                                <h5 class="card-title">Loans by PWDs (Overall)</h5>
                                <p class="card-text">' . $this->formatCurrency($pwdTotalLoanBalance) . '</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-6 col-lg-4" style="padding: 10px;">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <p class="card-text">' . $this->formatCurrency($pwdTotalBalance + $totalSavingsList['total_balance']) . '</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-6 col-lg-4" style="padding: 10px;">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <p class="card-text">
                                    <strong>Women:</strong> ' . $loansDisbursedToWomen . '<br>
                                    <strong>Men:</strong> ' . $loansDisbursedToMen . '<br>
                                    <strong>Youths:</strong> ' . $loansDisbursedToYouths . '
                                </p>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-6 col-lg-4" style="padding: 10px;">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <p class="card-text">
                                    <strong>Youths:</strong> ' . $loansGivenToYouths . '<br>
                                    <strong>PWDs:</strong> ' . $loansGivenToPwds . '
                                </p>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-6 col-lg-4" style="padding: 10px;">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <p class="card-text">
                                    <strong>Male:</strong> ' . $this->formatCurrency($pwdMaleLoanAmount) . '<br>
                                    <strong>Female:</strong> ' . $this->formatCurrency($pwdFemaleLoanAmount) . '
                                </p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-md-6 col-lg-4" style="padding: 10px;">
                        <div class="card">
                            <div class="card-body">
                                <h5 class="card-title">Loans Given to Refugees</h5>
                                <p class="card-text">
                                    <strong>Male:</strong> ' . $this->formatCurrency($refugeeMaleLoanAmount) . '<br>
                                    <strong>Female:</strong> ' . $this->formatCurrency($refugeeFemaleLoanAmount) . '
                                </p>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-6 col-lg-4" style="padding: 10px;">
                        <div class="card">
                            <div class="card-body">
                                <h5 class="card-title">Loans Given to Women</h5>
                                <p class="card-text">
                                    <strong>Female:</strong> ' . $this->formatCurrency($loanSumForWomen) . '<br>
                                    <strong>Male:</strong> ' . $this->formatCurrency($loanSumForMen) . '
                                </p>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-6 col-lg-4" style="padding: 10px;">
                        <div class="card">
                            <div class="card-body">
                                <h5 class="card-title">Loans Given to Men</h5>
                                <p class="card-text">
                                    <strong>Female:</strong> ' . $this->formatCurrency($loanSumForWomen) . '<br>
                                    <strong>Male:</strong> ' . $this->formatCurrency($loanSumForMen) . '
                                </p>
