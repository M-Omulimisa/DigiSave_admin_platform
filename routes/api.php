...
Route::post("update-loan-schemes", [ApiAuthController::class, "update_scheme"]);
...
Route::post("member-data", [ApiResurceController::class, "cycles"]);
...
Route::post('leader-verify', [ApiResurceController::class, 'verifyOtp']);
...
Route::post("request-otp-sms", [ApiResurceController::class, "requestAdminOtp"]);
